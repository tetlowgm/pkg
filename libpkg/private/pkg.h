...
DEFINE_VEC_INSERT_SORTED_PROTO(pkg_filev_t, pkg_filev, struct pkg_file);
void pkg_dir_free(struct pkg_dir *);
void pkg_dir_free_content(struct pkg_dir *);
int pkg_dir_cmp(const void *, const void *);
DEFINE_VEC_INSERT_SORTED_PROTO(pkg_dirv_t, pkg_dirv, struct pkg_dir);
...
DEFINE_VEC_INSERT_SORTED_PROTO(pkg_conflictv_t, pkg_conflictv, struct pkg_conflict);
...
DEFINE_VEC_INSERT_SORTED_PROTO(pkg_configfilev_t, pkg_configfilev, struct pkg_config_file);
